...
try:
    ...
    def main(created_IP_list,IP_list,new_IP_list):
        networkRange, IPAddress = ask_network_pref(get_self_IP())
        IP_list = created_IP_list(networkRange)
        created_IP_list(networkRange, IPAddress)
        find_hardware_info(new_IP_list)
        ...
        #print(find_hardware_info(new_IP_list))
    ...
    def created_IP_list(networkRange):
            IP_list = []
    ...
    def find_hardware_info(new_IP_list):
            ...
            while finale:
                ...
                print("Here is a list of all active IPs on your network: " + "\n")
                print(new_IP_list)
                print(end_script)
                if end_script == 'n':
                    finale = True
